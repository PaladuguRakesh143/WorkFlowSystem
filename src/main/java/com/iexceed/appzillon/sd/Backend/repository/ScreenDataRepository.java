package com.iexceed.appzillon.sd.Backend.repository;
...
// @Repository
// public interface SDJsonRepository extends JpaRepository<Field, Integer> {
...
@Repository
public interface ScreenDataRepository extends JpaRepository<SDJson, Long> {
    SDJson findByModuleNameAndScreenName(String moduleName, String screenName);
}
